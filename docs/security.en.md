...
- The web login dialog only passes user input into the browser/XHR HTTP Auth header; it does not add server-side sessions, cookies, or tokens, and it does not call the Dufs `LOGOUT` challenge endpoint.
